...
namespace Manage.Controllers
{
    public class TeacherController
    {
        ...
        public void Create()
        {
            ...
            ConsoleHelper.WriteTextWithColor(ConsoleColor.Yellow, "Enter teacher surname:");
            string surname = Console.ReadLine();

        Age: ConsoleHelper.WriteTextWithColor(ConsoleColor.Yellow, "Enter teacher age:");
            ...
            if (result)
            {
                ...
                if (dbTeacher != null)
                {
                    ConsoleHelper.WriteTextWithColor(ConsoleColor.Green, $"{dbTeacher.Name} {dbTeacher.Surname} is created");
                }
                else
                {
        ...
        public void Delete()
        {
            ...
            {
                ConsoleHelper.WriteTextWithColor(ConsoleColor.Red, "There are no any teachers");
            }
        }
